...
<div class="crd-head  text-center"><img  src="<?php echo e(asset('image/est.png')); ?>" class="card-img-top  round" /></div>
  <div class="card-body">
  <h5 class="card-title"><?php echo e($etapliss->nom_etablessement); ?></h5>
    <p class="card-text"><small class="text-muted"></small> Localisation  : <?php echo e($etapliss->local_etablessement); ?></p>
 <a href="http://127.0.0.1:8000/info/<?php echo e($etapliss->id_etabless); ?>"><p class="card-text">Learn more</p></a>
  </div>
</div>
</div><!-- fin col-->
...
<?php echo $__env->make("layouts/mylayout", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/testappleid/Desktop/gestion/test/resources/views/home.blade.php ENDPATH**/ ?>