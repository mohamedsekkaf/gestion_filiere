...
<div class="container">
  ...
  <div class="modal fade" id="etablissement">
    <div class="modal-dialog">
      ...
      <form action="<?php echo e(url('/insertetab')); ?>" method="POST">
        <!-- Modal Header -->
                  ...
                  <td> Non de filiere </td>
                     <td>
                        <select name="" id="">
                           ...
                           <option value="<?php echo e($model->id_filiere); ?>"><?php echo e($model->nom_filiere); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <!--<select name="" id="">
                           <option value="">default</option>
                  ...
                  <td> Non de filiere </td>
                     <td>
                        <select name="" id="">
                           ...
                           <option value="<?php echo e($modele->id_module); ?>"><?php echo e($modele->nom_module); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <!--<select name="" id="">
                           <option value="">default</option>
               ...
               <table>
                  ...
                  <tr>
                     ...
                     <select name="" id="">
                          ...
                          <option value="<?php echo e($dep->id_etablissement); ?>"><?php echo e($dep->nom_etablessement); ?></option>
                           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                     </td>
                  </tr>
