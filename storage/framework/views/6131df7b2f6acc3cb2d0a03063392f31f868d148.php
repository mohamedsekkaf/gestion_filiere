        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group tt">
                    ...
                    <input type="text" type="text" class="form-control" name="nom_etablessement"
                        value="<?php echo e(old('nom_etablessement')); ?>" placeholder="Nom de l'etablissement" id="nom" required />
                </div>
                <div class="form-group tt">
                    <label for="">Localisation</label>
                    <input type="text" type="text" class="form-control" name="local_etablessement"
                ...
                <div class="form-group tt">
                    ...
                    <input type="file" class="form-control upload" id="file" aria-hidden="true"
                        value="<?php echo e(old('image')); ?>" placeholder="image" name="image" />
                </div>
                <div class="form-group tt">
