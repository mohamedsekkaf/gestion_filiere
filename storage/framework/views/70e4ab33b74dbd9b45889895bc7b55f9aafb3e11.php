                    ...
                    <form action="<?php echo e(url('/ajouter')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <table>
                            <tr>
                                ...
                                <td><input class="form-control" type="text" name="nom_etablessement"
                                        value="<?php echo e(old('nom_etablessement')); ?>" placeholder="Nom de l'etablissement"
                                        id="nom"></td>
                            </tr>
                            <tr>
                                <td><br></td>
                            ...
                            <tr>
                                <td>Locatisation </td>
                                <td><input class="form-control" type="text" name="local_etablessement"
                                        value="<?php echo e(old('local_etablessement')); ?>" placeholder="Localisation" id="local"
                                        required></td>
                            </tr>
                            <tr>
                                <td><br></td>
                            ...
                            <tr>
                                ...
                                <td><input type="file" class="form-control" value="<?php echo e(old('images')); ?>" name="images"
                                        required></td>
                            </tr>
                            <tr>
                                <td><br></td>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <select class="form-control" name="nom_etabless" id="" required>
                                        ...
                                        <option value="<?php echo e($fil->nom_etablessement); ?>"><?php echo e($fil->nom_etablessement); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-control" name="nom_se" id="" required>
                                        ...
                                        <option value="<?php echo e($model->nom_s); ?>">S<?php echo e($model->nom_s); ?>->&nbsp;
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-control" name="nom_etap" id="" required>
                                        ...
                                        <option value="<?php echo e($dep->nom_etablessement); ?>"><?php echo e($dep->nom_etablessement); ?>
