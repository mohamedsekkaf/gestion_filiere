...
Route::get("/update/update-etablessement", 'etabliss@showNometab')->middleware('web');
Route::post("/update/update-etablessement", 'etabliss@updateetab')->middleware('web');
Route::get("/update/update-filiere", 'etabliss@showNomfil')->middleware('web');
Route::post("/update/update-filiere", 'etabliss@updatefiliere')->middleware('web');
Route::get("/update/update-module", 'etabliss@showNommod')->middleware('web');
Route::post("/update/update-module", 'etabliss@updatemodule')->middleware('web');
Route::get("/update/update-element", 'etabliss@showNomelem')->middleware('web');
