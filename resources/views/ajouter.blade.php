                        ...
                        <table>
                            <tr>
                                ...
                                <td><input class="form-control" type="text" name="nom_etablessement"
                                        value="{{ old('nom_etablessement')}}" placeholder="Nom de l'etablissement"
                                        id="nom"></td>
                            </tr>
                            <tr>
                                <td><br></td>
                            ...
                            <tr>
                                ...
                                <td><input class="form-control" type="text" name="local_etablessement"
                                        value="{{ old('local_etablessement')}}" placeholder="Localisation" id="local"
                                        required></td>
                            </tr>
                            <tr>
                                <td><br></td>
                            ...
                            <tr>
                                ...
                                <td><input type="file" class="form-control" value="{{ old('images')}}" name="images"
                                        required></td>
                            </tr>
                            <tr>
                                <td><br></td>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <select class="form-control" name="nom_etabless" id="" required>
                                        ...
                                        @foreach($etab as $fil)
                                        <option value="{{ $fil->nom_etablessement }}">{{ $fil->nom_etablessement }}
                                        </option>
                                        @endforeach
                                    </select>
                                    <!--<select name="" id="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-control" name="nom_se" id="" required>
                                        ...
                                        <option value="{{ $model->nom_s }}">S{{ $model->nom_s }}->&nbsp;
                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-control" name="nom_etap" id="" required>
                                        <option value="">default</option>
                                        @foreach($etab as $dep)
                                        <option value="{{$dep->nom_etablessement}}">{{ $dep->nom_etablessement }}
                                        </option>
                                        @endforeach
                                    </select>
                                </td>
