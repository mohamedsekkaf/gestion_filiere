               ...
               <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <input type="text"   class="form-control" name="nom_filiere" type="text"  value="{{ old('')}}" placeholder="Nom de filiere" id="nom"  />
                        </div>
                        <div class="form-group">
                            <input type="text"  class="form-control"  name="nummodel" type="number" value="{{ old('')}}" placeholder="Nombre de module" id="local"/>
                        </div>
                        <div class="form-group">
